...
@section('content')
    <main id="main" class="main">
        <div class="pagetitle">
            <h1>Tableau des articles postés</h1>
            <nav>
              <ol class="breadcrumb">
                <li class="breadcrumb-item"><a href="">Home</a></li>
                <li class="breadcrumb-item active">Articles postés</li>
              </ol>
            </nav>
          </div><!-- End Page Title -->
                                    ...
                                    <div class="card shadow-sm">
                                        ...
                                        <div class="card-body">
                                           <b><p class="card-text">{{$articles->article_nom }}</p></b>
                                            ...
                                            <div class="d-flex justify-content-between align-items-center" data-bs-toggle="tooltip" data-bs-placement="right" title="Veuillez vous enregistrez avant d'envoyer un message !!">
                                                <div class="btn-group">
                                                    <form method="POST" action="">
                                                        <a class="btn btn-sm btn-outline-secondary"  data-bs-toggle="modal" data-bs-target="#modalDialogScrollable" >Message</a>
                                                        <a class="btn btn-sm btn-outline-secondary" href="">Détail</a>
                                                    </form>
                                                </div>
